...
export default function LoginPage() {
    ...
    return (
        <div className="min-h-screen w-full flex items-center justify-center p-4 sm:p-6 bg-gray-50 dark:bg-slate-950">
            {/* Main Container */}
            <motion.div
                initial={{ opacity: 0, scale: 0.95, y: 20 }}
                animate={{ opacity: 1, scale: 1, y: 0 }}
                transition={{ duration: 0.4, ease: [0.22, 1, 0.36, 1] }}
                className="w-full max-w-xl mx-auto rounded-[24px] bg-[#FAF9F6] dark:bg-slate-900 shadow-[0_20px_60px_-15px_rgba(0,0,0,0.5)] overflow-hidden border border-gray-100 dark:border-slate-800"
            >
                <div className="w-full p-8 sm:p-12 flex flex-col justify-center relative bg-gradient-to-b from-[#FAF9F6] to-[#F3F0E6] dark:from-slate-900 dark:to-slate-950">

                    <div className="mb-6 inline-flex justify-center w-full">
                        <Link href="/" className="px-5 py-2 rounded-full border border-gray-200/60 dark:border-gray-700/60 bg-white/60 dark:bg-slate-800/60 backdrop-blur-md text-sm font-bold text-gray-800 dark:text-gray-100 shadow-sm flex items-center gap-2 hover:bg-white dark:hover:bg-slate-800 transition-colors cursor-pointer">
                    ...
                    <div className="mx-auto w-full max-w-md">
                        ...
                        <div className="flex gap-2 mb-6 sm:mb-8 justify-center">
                            {[
                                ...
                                <button
                                    ...
                                    className={`px-6 py-2.5 rounded-full text-[14px] font-bold transition-all duration-300 ${loginRole === role.key
                                        ? role.activeClass
                        ...
                        <div className="text-center mb-8">
                            <h2 className="text-3xl sm:text-4xl leading-tight font-heading font-extrabold text-[#1A1A1A] dark:text-white mb-2 tracking-tight">
                                Welcome Back
                            </h2>
                            <p className="text-[#6B7280] dark:text-gray-400 text-[14px] font-medium max-w-[280px] mx-auto">
                                Sign in to access the Zeeque Preschool platform
                            </p>
                        </div>
                        ...
                        <form className="space-y-4" onSubmit={handleSubmit(onSubmit, onError)} noValidate>
                                ...
                                <AnimatePresence>
                                    {getFieldState("email").hasError && (
                                        <motion.p
                                            ...
                                            exit={{ opacity: 0, y: -4 }}
                                            className="text-red-500 text-[13px] font-medium mt-1.5 ml-5"
                                        >
                            ...
                            <div className="flex justify-end pr-2">
                                <Link href="#" className="text-[13px] font-bold text-[#4361EE] hover:text-[#3A56D4] transition-colors">
                                    Forgot Password?
                                </Link>
                            </div>

                            <div className="pt-4 mt-4 border-t border-dashed border-gray-200 dark:border-slate-800">
                                <button
                                    type="submit"
                                    className="w-full bg-primary text-white font-heading font-extrabold text-[16px] py-4 rounded-[16px] shadow-[0_10px_30px_rgba(232,62,140,0.3)] hover:shadow-[0_15px_40px_rgba(232,62,140,0.4)] transition-all duration-300 flex items-center justify-center gap-3 overflow-hidden group relative hover:-translate-y-0.5"
                                >
                        ...
                        <div className="mt-6">
                            <div className="relative mb-6">
                                ...
                                <div className="relative flex justify-center text-sm">
                                    <span className="px-4 bg-[#FAF9F6] dark:bg-slate-900 text-gray-500 font-medium">Or continue with</span>
                                </div>
                            </div>

                            <div className="flex gap-4">
                                <button className="flex-1 flex items-center justify-center gap-3 py-3 rounded-[16px] border border-gray-200/80 dark:border-slate-700 bg-white dark:bg-slate-800 hover:bg-gray-50 dark:hover:bg-slate-700/70 transition-colors text-[14px] font-bold text-gray-700 dark:text-gray-200 shadow-sm">
