                            ...
                            <div className="max-w-md mx-auto w-full">
                                ...
                                <div className="mt-4">
                                    <div className="flex gap-3">
                                        <button className="flex-1 flex items-center justify-center gap-2 py-2.5 rounded-[14px] border border-gray-200/80 dark:border-slate-700 bg-white dark:bg-slate-800 hover:bg-gray-50 dark:hover:bg-slate-700/70 transition-colors text-[13px] font-bold text-gray-700 dark:text-gray-200 shadow-sm">
